...
function handleDashboardCommunication(event: CustomEvent) {
...
function initialize() {
  ...
  document.addEventListener('ghostscan-test-connection', handleDashboardCommunication as EventListener);
  document.addEventListener('ghostscan-start-scan', handleDashboardCommunication as EventListener);
  document.addEventListener('ghostscan-get-data', handleDashboardCommunication as EventListener);
}
